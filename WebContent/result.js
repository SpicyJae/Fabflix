...
function handleSearchResult(resultData) {
    ...
    if (prevPageNum > 0) {
    	prevElement.append('<span><a href="result.html?title=' + title + '&year=' + year
				+ '&director=' + director + '&name=' + name 
    ...
    nextElement.append('<span><a href="result.html?title=' + title + '&year=' + year
			+ '&director=' + director + '&name=' + name 
    		+ '&order=' + order + '&page=' + nextPage + '&ipp=' + ipp
    		+ '"><i class="fa fa-angle-right"></i></a></span>');
    
    let resultPageElement = jQuery("#result-page");
    resultPageElement.append('<span><a href="result.html?title=' + title + '&year=' + year
			+ '&director=' + director + '&name=' + name 
